      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.container}>
          ...
          <View style={styles.card}>
            ...
            <TouchableOpacity 
              style={[styles.button, { marginTop: 20, backgroundColor: '#6B7280' }]} 
              onPress={() => {
                console.log('Manual retry of AA initialization');
                initializeAA();
              }}
            >
      ...
      <ScrollView contentContainerStyle={styles.scrollView}>
        <View style={styles.container}>
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.addressValue}>{address ? `${address.slice(0, 6)}...${address.slice(-4)}` : 'Not connected'}</Text>
          </View>
          <View style={styles.card}>
            {isRegistered ? (
              <>
