...
contract AccountAbstraction {
    ...
    ICrossNetworkESIM public immutable crossNetworkESIM;
    ...
    constructor(
        ...
        crossNetworkESIM = ICrossNetworkESIM(_crossNetworkESIM);
    ...
    function sendCrossNetworkMessage(
        ...
        crossNetworkESIM.sendCrossNetworkMessage(
            to,
            networkId,
            encryptedMessage
        );
    ...
    function createESIMProfile(
        ...
        return crossNetworkESIM.createESIMProfile(
            networkOperator,
            profileData
        );
    }
    ...
    function activateESIMProfile(
        ...
        crossNetworkESIM.activateESIMProfile(tokenId, activationCode);
    }
