...
console.log('App.tsx - projectId:', projectId);
console.log('App.tsx - env vars:', {
...
// Only create Web3Modal if projectId is available
if (projectId) {
	createWeb3Modal({
		projectId,
		chains,
		...
		return (
			<AddressProvider>
				<SafeAreaProvider>
					...
					<StatusBar />
					{/* Temporarily disabled: {projectId && <Web3Modal />} */}
				</SafeAreaProvider>
			</AddressProvider>
		);
	}
